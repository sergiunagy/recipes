package playground.springframework.recipes.bootstrap;

import playground.springframework.recipes.domain.*;
import playground.springframework.recipes.domain.repositories.CategoryRepository;
